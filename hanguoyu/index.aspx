        ...
        <div id="chipupu-index-content-3">
            <div id="chipupu-index-content-3-content1" class="parallel-width">
                ...
                <p>
                   ...
                   <span>由於再活動期間現在只要<b>滿8組</b>就可以免運費喔，如果想進一步了解可以往下找到我們的聯絡方式。</span>或 <a href=""><i class="fas fa-link"></i> 點此</a>
                </p>
            </div>
        </div>
                ...
                <div class="chipupu-index-content-parallel-Row">
                    <form method="post">
                        <div class="chipupu-form-input">
                            <h3>RFID個資防盜卡韓粉A款</h3>
                            <div class="chipupu-form-img">
 
                            </div>
                            <div class="chipupu-form-Title">
                                <label>
                                    <input type="number" name="chipupu1" value="0">
                                </label> 
                            </div>
                        </div>
                        <div class="chipupu-form-input">
